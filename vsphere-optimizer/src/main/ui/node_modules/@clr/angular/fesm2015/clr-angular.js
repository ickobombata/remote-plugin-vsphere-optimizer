...
const ɵ1 = key => DatagridColumnChanges[key], ɵ0$1 = key => key === parseInt(key, 10);
const ALL_COLUMN_CHANGES = Object.keys(DatagridColumnChanges)
    .map(ɵ1)
    .filter(ɵ0$1); // extracts only integer keys
...
ClrVerticalNavGroup.propDecorators = {
    ...
    groupLabel: [{ type: Input, args: ['clrVerticalNavGroupLabel',] }],
