...
export declare const logMissingPackages: (dependencies: LogMissingPackagesDependencies, ruleConversionResults: Pick<SummarizedConfigResultsConfiguration, "extends" | "missing" | "plugins">, packageConfiguration?: PackagesConfiguration) => Promise<void>;
