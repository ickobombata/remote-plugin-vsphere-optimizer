...
table[cds-table] {
  ...
  --border-radius: var(--cds-alias-object-border-radius-100, calc(4 / var(--cds-global-base, 20) * 1rem));
  --border: var(--cds-alias-object-border-width-100, calc(1 / var(--cds-global-base, 20) * 1rem)) solid var(--cds-alias-object-border-color, var(--cds-global-color-construction-200, #cbd4d8));
  --header-background: var(--cds-alias-object-container-background-tint, var(--cds-global-color-construction-50, #f1f6f8));
  --header-border: var(--cds-alias-object-border-width-100, calc(1 / var(--cds-global-base, 20) * 1rem)) solid var(--cds-alias-object-border-color, var(--cds-global-color-construction-200, #cbd4d8));
  --row-border: var(--cds-alias-object-border-width-100, calc(1 / var(--cds-global-base, 20) * 1rem)) solid var(--cds-alias-object-border-color-tint, var(--cds-global-color-construction-100, #e3eaed));
  --column-border: var(--cds-alias-object-border-width-100, calc(1 / var(--cds-global-base, 20) * 1rem)) solid var(--cds-alias-object-border-color-tint, var(--cds-global-color-construction-100, #e3eaed));
  --cell-padding: var(--cds-global-space-5, calc(8 / var(--cds-global-base, 20) * 1rem)) var(--cds-global-space-6, calc(12 / var(--cds-global-base, 20) * 1rem));
}
